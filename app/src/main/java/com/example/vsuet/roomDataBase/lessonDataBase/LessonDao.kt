...
interface LessonDao {
    ...
    @Query("SELECT * FROM lessonPair WHERE groupName like :groupName AND podGroup like :podGroup")
    fun getGroupLessons(groupName: String, podGroup: Int) : LiveData<List<LessonPair>>
